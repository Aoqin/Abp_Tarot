...
namespace Acme.Tarot.Migrations
{
    ...
    [Migration("20210304013513_CREATE_TABLE_TAROT_CARD_SOLUTIONS")]
    partial class CREATE_TABLE_TAROT_CARD_SOLUTIONS
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.Tarot.Cards.CardBindCollection", b =>
                {
                    b.Property<Guid>("TarotCardId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TarotCardCollecitonId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("TarotCardId", "TarotCardCollecitonId");

                    b.HasIndex("TarotCardCollecitonId");

                    b.ToTable("CardBindCollection");
                });
            ...
            modelBuilder.Entity("Acme.Tarot.Cards.TarotCard", b =>
                {
                    ...
                    b.Property<string>("CardContentText")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("CardFrontImgUrl")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("Acme.Tarot.Cards.TarotCardCollection", b =>
                {
                    ...
                    b.Property<string>("CardBackImgUrl")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasDefaultValue("123");
                    ...
                    b.Property<int>("DivinationLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
                    ...
                    b.ToTable("AppTarotCardCollections");
                });
            ...
            modelBuilder.Entity("Acme.Tarot.Cards.TarotCardSolution", b =>
                {
                    ...
                    b.Property<string>("TarotCardIdsToString")
                    ...
                    b.Property<string>("Hexagram")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");

                    b.Property<string>("HexagramExplain")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
                    ...
                    b.HasKey("TarotCardCollectionId", "TarotCardIdsToString");

                    b.ToTable("AppTarotCardSolutions");
                });
            ...
            modelBuilder.Entity("Acme.Tarot.Cards.CardBindCollection", b =>
                {
                    b.HasOne("Acme.Tarot.Cards.TarotCardCollection", "TarotCardCollection")
                        .WithMany("CardBindCollections")
                        .HasForeignKey("TarotCardCollecitonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.Tarot.Cards.TarotCard", "TarotCard")
                        .WithMany("CardBindCollections")
